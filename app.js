...
import response_upload from './middleware/response_upload.js';
...
app.post('/api/render_album', render_controller, setup_dir, fetch_images, cover, inside_cover, photos, merge_pdf, response_upload, cleanup, (req, res) => {
